...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="#">Home</a> / Louer</span>
    <h2>Louer</h2>
</div>
</div>
<!-- banner -->
...
<!-- #Slider Ends -->
  ...
  <div class="spacer"><h4><span class="glyphicon glyphicon-th-list"></span> Caractéristiques </h4>
...
<p class="price">200,000</p>
  <p class="area"><span class="glyphicon glyphicon-map-marker"></span>  Cotonou</p>
  
  <div class="profile">
  <span class="glyphicon glyphicon-user"></span> Infos Agent 
  <p>Eve daSilva<br>229 60 61 62 63 229 2929</p>
  </div>
</div>

    <h6><span class="glyphicon glyphicon-home"></span> Dsponibilité</h6>
